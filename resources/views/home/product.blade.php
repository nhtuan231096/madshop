                ...
                <div class="row row-pb-lg product-detail-wrap">
                        ...
                        <div class="item">
                            <div class="product-entry border">
                                <a href="{{route('view',['slug'=>$product->slug])}}" class="prod-img">
                                    <img src="{{asset('uploads')}}/{{$product->image}}" class="img-fluid" alt="Free html5 bootstrap 4 template">
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="product-desc">
                            ...
                            <p class="price">
                                ...
                                <s><span class="price">Price: {{number_format($product->price)}}đ</span></s>
                                <span class="price">Sale Price: {{number_format($product->sale_price)}}đ</span>
                                @else
                    ...
                    <div class="row">
                        <div class="col-sm-12 text-center">
                                    <p class="addtocart"><a href="{{route('add-cart',['id'=>$product->id])}}" class="btn btn-primary btn-addtocart"><i class="icon-shopping-cart"></i> Add to Cart</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
